...
// Player Status
Template.game_player_status.helpers({
...
Template.game_player_status.events({
    'click button': function(evt, template){
        console.log(this);
...
// Deck Selector
Template.game_deckselector_dropdown.helpers({
    decks: function(){ return Decks.find(); }
    //deckname: function() { return Decks.findOne({_id: this.deckId}).name; }
});
